...
class Addnewpost extends Component{
    ...
    handleAddnewProductClick = () =>{
        this.setState(prevState => ({
            newproductlist: !prevState.newproductlist,
        }));
    }

    render(){
        const {productlist, newproductlist} = this.state
        return(
            <div className='addpost-container'>
                <select id="categorySelect" className='select-container'>
                ...
                <input type='text' placeholder='Post Name' className='postname-input'/>
                <input type='text' placeholder='Associated Video Link' className='postname-input'/>
                <input type='text' placeholder='Tag Products' className='postname-input'/>
                <button className='add-button'  onClick={this.handleAddProductClick}>+Add Product</button>
                {productlist ? (
                    <div className='sub-container'> 
                    <input type='text' placeholder='ProductName' className='sub-container-input'/>
                    <input type='text' placeholder='ProductImageLink' className='sub-container-input'/>
                    <input type='text' placeholder='Price' className='sub-container-input'/>
                </div>
                ): ""}
                <button className='add-button' onClick={this.handleAddnewProductClick}>+Add New Product</button>
                {newproductlist ? (
                    <div className='sub-container'> 
                    <input type='text' placeholder='ProductName' className='sub-container-input'/>
                    <input type='text' placeholder='ProductImageLink' className='sub-container-input'/>
